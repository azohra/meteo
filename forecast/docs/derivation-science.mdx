...
[`forecast/src/derive/lapse.ts`](https://github.com/azohra/meteo/blob/main/briefing/src/derive/lapse.ts) and
[`forecast/src/derive/stability.ts`](https://github.com/azohra/meteo/blob/main/briefing/src/derive/stability.ts).
