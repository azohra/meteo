...
lift, all baked into every published profile. The
...
If the parcel stays warmer than the entire available sounding, the code returns the top level. That value is
