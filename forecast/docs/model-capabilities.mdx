...
— and the readout wording follows the declaration: only the hour-maximum supports
...
storm question — while ECCC publishes exactly one: surface-based. The forecast engine publishes the
