...
121 m/°C is the value canadarasp's `windgram-continental.ncl` used. This project inherited it the way it
...
Both real columns were re-derived old-versus-new: the 15-hour HRDPS column behind the
