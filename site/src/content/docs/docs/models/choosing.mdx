...
Both NAM entries carry a declared `sunset` in the catalogue — retired 2026-10-06, succeeded by
RRFS, which already publishes through the same contract as an experimental feed — so weigh that
