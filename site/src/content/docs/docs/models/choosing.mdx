...
| --- | --- | --- |
| What will the launch do today? | HRDPS 1 km (an experimental feed) / 2.5 km, HRRR or NAM nest 3 km | each other, then observations |
...
RRFS — so weigh that date when building anything durable on them; the
